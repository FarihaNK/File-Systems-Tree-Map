...
class View:
    ...
    height: int
    font_height: int
    tree: Optional[TreeMap]
    screen: Optional[pygame.Surface]
    hover_node: Optional[TreeMap]
    selected_node: Optional[TreeMap]
    ...
    def run_visualisation(self, tree: TreeMap) -> None:
    ...
    def _handle_click(self, button: int, pos: tuple[int, int],
                      old_selected_leaf: Optional[TreeMap]) -> Optional[TreeMap]:
